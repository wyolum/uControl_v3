...
from numpy import log10, exp, pi, sqrt, arctan2, real, imag, sin, cos
import scipy
...
def trapz_intrgral__test__():
    ...
    a = .5
    b = 4.5
    assert abs(trapz_intrgral(x, y, a, b) - 20) < 1e-8
...
def find_pulse_peaks_and_troughs(data, pulse_period, dt):
...
def find_pulse_peaks_and_troughs__test__():
    ...
    peaks, troughs = find_pulse_peaks_and_troughs(data, pulse_period, dt)
