...
const bool   VALVE_OPEN = true;
const bool VALVE_CLOSED = false;
...
const byte LIQ_PRESS_ADDR = 120; // 0b1111000;
 ...
 */
void control_valve(boolean duty_cycle);
void valve_close();
void valve_open();
